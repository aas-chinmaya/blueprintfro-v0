...
//   // Use subtasks directly from task prop
...
// Assume updateSubTask is defined in subTaskSlice
import { updateSubTask ,updateSubTaskStatus} from '@/features/subTaskSlice';

const SubTaskList = ({ task, subtasks, taskId, isTaskClosed }) => {
  // Use subtasks directly from prop
  console.log(subtasks);
  ...
  const handleToggleStatus = async (subtask) => {
    ...
    try {
      ...
      // Assuming successful dispatch updates the subtasks prop via Redux store
    } catch (err) {
