...
"[project]/src/components/form/LoginForm.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LoginForm = ()=>{
        ...
        "LoginForm.useEffect": ()=>{
            const checkAuthStatus = {
                "LoginForm.useEffect.checkAuthStatus": async ()=>{
                    try {
                        await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$shared$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkAuth"])()).unwrap();
                    } catch  {} finally{
    ...
    const handleLoginSubmit = async (e)=>{
        ...
        try {
            const response = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$shared$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["login"])({
                email,
                password
            })).unwrap();
    ...
    const handleOtpSubmit = async ()=>{
        ...
        try {
            const response = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$shared$2f$authSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verifyOtp"])({
                email,
                otp: otpValue
            })).unwrap();
...
//# sourceMappingURL=src_4931948e._.js.map