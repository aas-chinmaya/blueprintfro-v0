...
_s(CreateSubtaskModal, "IA5NPijhGbXK2yGlQbG/w2VstnE=", false, function() {
    return [
...
const DeleteSubtaskModal = ({ open, setOpen, subtask, taskId })=>{
    ...
    const confirmDelete = async ()=>{
        try {
            ...
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$subTaskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSubTask"])({
                taskId,
...
const SubTaskList = ({ task, taskId, isTaskClosed })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubTaskList.useEffect": ()=>{
            if (taskId) {
                dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$subTaskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSubTasksByTaskId"])(taskId));
            }
        }
    }["SubTaskList.useEffect"], [
        dispatch,
    ...
    const handleToggleStatus = async (subtask)=>{
        ...
        try {
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$subTaskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateSubTaskStatus"])({
                taskId,
                subtaskId: subtask.subtask_id,
                status: nextStatus
            }));
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Subtask status updated to ${nextStatus}`);
        } catch (err) {
...
_s(SubTaskList, "y/ZAHY7j0CpeZA02tDgF0Uzm9a4=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$bugSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/bugSlice.js [app-client] (ecmascript)"); // Adjust the import path to where `createBug` is defined
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/sonner/dist/index.mjs [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
...
const ReportBugModal = ({ onClose, task_id })=>{
    ...
    const [priority, setPriority] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Low'); // Default to 'medium'
    ...
    const handleReportBug = async ()=>{
        ...
        try {
            const result = await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$bugSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBug"])(bugData)).unwrap();
...
_s(ReportBugModal, "c4Yw+gU8r3FnOKBvxBbv1Fh/mNQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"]
    ];
});
...
const TaskView = ()=>{
    ...
    const handleSubmitDelayReason = async ()=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`Task status updated to ${pendingStatus}`);
            dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTaskById"])(task_id));
    ...
    const handleMarkAsResolved = async ()=>{
        if (updating) return;
        try {
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$taskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateTaskReviewStatus"])({
                task_id: task_id,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Task marked as Resolved and fully closed");
        } catch (err) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Failed to mark task as Resolved");
        }
    };
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                            ...
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 626,
                                columnNumber: 15
                            }, this) : error || !task ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                children: [
                                                                                    ...
                                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                        className: "font-medium",
                                                                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$formatDate$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDateUTC"])(task?.deadline) || "N/A"
                                                                                    }, void 0, false, {
                                                                                        fileName: "[project]/src/modules/Tasks/task/ViewTask.jsx",
                                                                                        lineNumber: 823,
                                                                                        columnNumber: 29
...
_s(TaskView, "qN6i/e5LmdgJ4iwvbDY5mpjnBFI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_ce48bdad._.js.map