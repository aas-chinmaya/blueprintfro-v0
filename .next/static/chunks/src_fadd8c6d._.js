...
"[project]/src/modules/Tasks/sub-task/CreateSubTaskModal.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$subTaskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/subTaskSlice.js [app-client] (ecmascript)"); // Import the async thunk
...
const CreateSubtaskModal = ({ open, setOpen, taskId })=>{
    ...
    }["CreateSubtaskModal.useSelector"]); // Access Redux state
    const isTaskClosed = false; // This should ideally come from props or Redux state
    const handleAdd = async ()=>{
        if (isTaskClosed || !newTitle.trim()) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Cannot add subtask: Task is closed or title is empty');
            return;
        }
        try {
            // Dispatch the createSubTask async thunk
            await dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$subTaskSlice$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSubTask"])({
                taskId,
                subTaskData: {
                    title: newTitle
                }
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error || 'Failed to add subtask');
        }
    };
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogClose"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: loading ? 'Adding...' : 'Add Subtask'
                            }, void 0, false, {
                                fileName: "[project]/src/modules/Tasks/sub-task/CreateSubTaskModal.jsx",
                                lineNumber: 60,
                                columnNumber: 13
...
_s(CreateSubtaskModal, "l1TE42EtcQ7kiKNPgcRhm7bHA3U=", false, function() {
    return [
...
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
 ...
 //   const currentUser = useCurrentUser(); // Get current user details
 ...
 //     description: '',
 //     assignedTo: '',
 //     assignedBy: currentUser?.id || '', // Prefill with current user's ID
 //   });
 //   const dispatch = useDispatch();
 //   const { loading, error } = useSelector((state) => state.subTask);
 //   const isTaskClosed = taskDetails?.status === 'Closed'; // Determine if task is closed
 ...
 //   const handleAdd = async () => {
 //     if (isTaskClosed) {
 //       toast.error('Cannot add subtask: Task is closed');
 //       return;
 //     }
 //     if (!formData.title.trim() || !formData.assignedTo || !formData.assignedBy) {
 //       toast.error('Title, Assigned To, and Assigned By are required');
 //       return;
 //     }
 //     try {
 //       const subTaskData = {
 ...
 //     }
 //   };
 //   // Assume taskDetails.users contains available users for assignment
 //   const availableUsers = taskDetails?.users || [];
 //   return (
 ...
 //               disabled={isTaskClosed || loading || !availableUsers.length}
 //             >
 //               <SelectTrigger className="mt-1 text-xs sm:text-sm">
 ...
 //               <p className="text-red-500 text-xs mt-1">No users available for assignment</p>
 //             )}
 //           </div>
 //           <div>
 ...
 //               onChange={handleChange}
 //               className="mt-1 text-xs sm:text-sm"
 //               disabled={true} // Disabled since it's set to current user
...
"[project]/src/modules/Tasks/sub-task/EditSubTaskModal.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const EditSubtaskModal = ({ open, setOpen, subtask, subtasks, setSubtasks, isTaskClosed })=>{
    ...
    const [editStatus, setEditStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(subtask.status);
...
_s(EditSubtaskModal, "69/iJ5wtiiWS6MXoRZkrQ9cHwGE=");
_c = EditSubtaskModal;
...
"[project]/src/modules/Tasks/sub-task/DeleteSubTaskModal.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/modules/Tasks/sub-task/SubTaskList.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$CreateSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/Tasks/sub-task/CreateSubTaskModal.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$EditSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/Tasks/sub-task/EditSubTaskModal.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$DeleteSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/modules/Tasks/sub-task/DeleteSubTaskModal.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/dialog.jsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
...
const SubtaskList = ({ task, taskId, isTaskClosed })=>{
    ...
    // Modal states
    const [openView, setOpenView] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Open by default for demo
    const [openEdit, setOpenEdit] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Open by default for demo
    const [openAdd, setOpenAdd] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Open by default for demo
    const [openDelete, setOpenDelete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Open by default for demo
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$CreateSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                open: openAdd,
                setOpen: setOpenAdd,
                taskDetails: task,
                taskId: taskId
            ...
            selectedSubtask && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$EditSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                open: openEdit,
                setOpen: setOpenEdit,
            ...
            selectedSubtask && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$DeleteSubTaskModal$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                open: openDelete,
...
_s(SubtaskList, "LP+GdN8q/LICyg6oWiOHDJLbqPQ=");
_c = SubtaskList;
...
"[project]/src/modules/Tasks/sub-task/CloseTaskModal.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var _c;
__turbopack_context__.k.register(_c, "CloseTaskModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$modules$2f$Tasks$2f$sub$2d$task$2f$SubTaskList$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                isTaskClosed: false,
                                                taskId: task?.task_id
                                            }, void 0, false, {
                                                fileName: "[project]/src/modules/Tasks/task/ViewTask.jsx",
...
_s(TaskView, "6Tq50pmnYjp6O65N+fHWx45gHBw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDispatch"],
...
//# sourceMappingURL=src_fadd8c6d._.js.map